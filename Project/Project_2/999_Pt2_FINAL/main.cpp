 ...
 * Purpose: 999 Second Installment Final Version
 * 
 * Changes list:
 * Fixed loop statements to work with other choices (previously had it backwards)
 * Incorporated as much array usage as possible (quite difficult with a decision making game)
 */
...
void path5() {
    ...
    cout << "You see the keypad next to the door." << endl;
    keypad();
    ...
    //Prompt player for choice via array
    ...
    //Display array
    cout << "The code you have inputted is:" << endl;
...
void keypad() {
    ...
    //Produce a 2D array with bubble sorting
